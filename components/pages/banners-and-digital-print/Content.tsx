  ...
  return (
    <>
      <Hero
        ...
        title="Banners and Digital Print"
      ...
      <TextImage
        id="full-color-digital-print-banners"
        title="Full Color Digital Print Banners"
        description={bannersDesc}
        imageName="mountain-works.png"
      />
      <TextImage
        id="stickers"
        title="Stickers Signs"
        description={stickersDesc}
        imageName="ds-works.png"
      />
      <TextImage
        id="poster-and-all-other-media"
        title="Poster And All Other Media"
