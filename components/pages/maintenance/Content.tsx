...
const Content = () => {
  ...
  const heroDesc =
    "The exterior signs serve an incredibly important role in your business. With an eye-popping signage, you are sure that you are making your business more visible and more attractive to the potential customers including the passersby.  However, like all other strategic assets, you ought to make sure you are taking good care of the exterior signs. Therefore, it is important to make sure you are taking good care of the business signage.";
  ...
  return (
    <>
      <Hero
        ...
        title="Maintenance"
        subTitle="Reputable Signage Maintenance Company"
      ...
      <TextImage
        id="all-electrical-signs"
        title="All Electrical Signs"
        description={electricalDesc}
      ...
      />
      <TextImage
        id="sign-cabinets-and-lighting"
        title="Sign Cabinet and Lighting"
        description={cabinetDesc}
        imageName="mountain-works.png"
      />
    </>
  );
